...
- 2026-09-25 — **C10 and C11 done, community-portal fully ported and
  ...
  awareness. With C10/C11 done, Workstream C is now fully closed except
  C5 (still blocked on C6 Finding 3's disposition, itself already
  resolved by fix — C5 just needs its own bookkeeping pass) and the
  outstanding founder decisions (C4's community-portal question is now
  moot, since it was resolved this session; H1's migration-path
