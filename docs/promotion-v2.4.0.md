...
| D1 | Classify every row into Bucket A/B/C using the inventory — supersedes the earlier prose-based first pass | Not started — 508 of 526 rows still need classification |
