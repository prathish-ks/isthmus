...
// Kernel supervisor (Phase 11, P10-01) — starts/stops `nanogo serve` in
// step with this host process. Direct core import, not routed through the
// modules barrel above, matching that barrel's own documented convention
// for default, always-on modules (see src/modules/index.ts's header
// comment: "Default modules... direct core import" — the same treatment
// typing/ and mount-security/ already get).
import './modules/kernel-supervisor/index.js';
