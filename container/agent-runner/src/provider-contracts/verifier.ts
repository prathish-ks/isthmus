/**
 * v2.4.0 promotion, Workstream C15: ported verbatim — self-contained shape
 * and behavioral-probe checks for a `ProviderRuntimeContract`, no
 * Isthmus-specific divergence needed here.
 */
import {
