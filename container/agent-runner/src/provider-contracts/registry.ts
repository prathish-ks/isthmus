 ...
 *
 * v2.4.0 promotion, Workstream C15 (provider-runtime-contract port). Ported
 * near-verbatim — this file is self-contained, no Isthmus-specific
 * divergence needed here (the divergences this port makes live in
 * `providers/types.ts`, `providers/claude.ts`, and
 * `provider-contracts/claude.ts` — see their own headers).
 */
