/**
 * v2.4.0 promotion, Workstream C15: ported verbatim. Self-contained given
 * `provider-registry.ts` (two-step registration) and `memory/session-hook.ts`
 * (unchanged between v2.3.0 and v2.4.0) — no Isthmus-specific divergence
 * needed here.
 */
import {
  type Capability,
